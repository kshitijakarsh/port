...
export default function DesignPage() {
  ...
  return (
    <main className="overflow-x-hidden">
      <Button variant="social" href="/" className="fixed top-4 left-4 z-50">
        <MoveLeft size={14} />
        Back
      </Button>
      <section ref={triggerRef} className="h-screen overflow-hidden bg-background">
        <div ref={containerRef} className="flex h-full w-fit flex-row items-center">
          ...
          <div className="relative flex h-screen w-screen shrink-0 items-center justify-center border-r border-border">
            ...
            >
              <h1 ref={scrollRef} className="text-xl font-bold text-foreground">
                scroll.
              </h1>
            </div>
          </div>
          ...
          {designs.map((design, index) => (
            ...
            >
              ...
              >
                <VideoCard videoSrc={design.videoSrc} videoType={design.videoType} />
              </div>
