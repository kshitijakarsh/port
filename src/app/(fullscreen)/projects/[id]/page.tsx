  ...
  return (
    <main className="h-screen bg-background text-foreground relative overflow-hidden font-sans selection:bg-foreground selection:text-background py-16 px-4 md:px-8">
      <div className="relative z-10 w-full h-full">
        <Button variant="social" href="/projects" className="fixed top-8 left-8 z-50 rounded-full">
          <MoveLeft size={14} />
          Back
        </Button>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start h-full">
          <div className="lg:col-span-3 flex flex-col justify-between h-full py-12">
            <div className="space-y-12">
              ...
              <div className="gap-x-12 gap-y-8 max-w-sm">
                <div className="space-y-1.5">
                  <p className="text-[10px] uppercase tracking-tighter font-bold text-muted-foreground/40 font-fragment">
                    Year
                  </p>
                ...
                <div className="space-y-1.5 mt-2">
                  ...
                  <p className="text-xs font-medium uppercase tracking-tighter font-fragment text-emerald-400">
                    [{project.field}]
                  </p>
                </div>

                <div className="space-y-1.5 mt-2">
                  <p className="text-[10px] tracking-tighter font-bold text-muted-foreground/40 font-fragment uppercase">
                    Technologies
                  </p>
                  <div className="flex flex-wrap gap-x-4 gap-y-1">
                    {project.techUsed.map((tech) => (
                      <span key={tech.id} className="text-sm font-medium uppercase tracking-tight">
                        {tech.stack}
                      </span>
                    ))}
                  </div>
            ...
            <div className="space-y-4 pt-8">
              <p className="text-[10px] uppercase tracking-[0.2em] font-bold text-muted-foreground/40 font-fragment">
                Connections
              </p>
