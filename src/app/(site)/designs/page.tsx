            ...
            <div className="flex flex-col items-center justify-center flex-1 text-center px-4 gap-6 pb-20">
                ...
                <div>
                    ...
                    <p className="text-muted-foreground text-sm max-w-sm mx-auto leading-relaxed">
                        I&apos;m currently curating a collection of design works, motion graphics, and UI experiments. Come back soon to see what I&apos;ve been building.
                    </p>
                </div>

                <div className="flex gap-4 items-center">
                    <div className="h-px w-8 bg-border" />
                    <span className="text-[10px] uppercase tracking-[0.2em] font-bold text-muted-foreground/40 font-fragment">Coming Soon</span>
                    <div className="h-px w-8 bg-border" />
                </div>
            </div>
        </div>
