                    ...
                    {blogs.map((blog) => (
                        ...
                        >
                            <div className="flex flex-col gap-2">
                                <p className="text-2xl font-serif group-hover:text-foreground transition-colors">{blog.title}</p>
                                <div className="flex gap-2">
                                    {blog.tags.map((tag: string) => (
                                        <span key={tag} className="text-xs text-muted-foreground bg-muted outline-1 outline-border outline-offset-1 px-2 py-0.5 rounded-sm">
                                            {tag}
                                        </span>
                                    ))}
                                </div>
